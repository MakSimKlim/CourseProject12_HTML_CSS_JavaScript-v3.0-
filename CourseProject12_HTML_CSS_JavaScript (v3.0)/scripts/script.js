		...
		$(document).ready(function(){
			...
			// Закрыть popup окно при нажатии на крестик
			$(".close").click(function() {
				$("#overlay, #registerModal").fadeOut();
			});

			// Закрыть popup окно при нажатии вне его
       ...
       function loadMap() {
        ...
        request.onerror = function() {
            document.getElementById('weather-info').innerText = 'Произошла ошибка при загрузке данных.';
        };
        request.send();
